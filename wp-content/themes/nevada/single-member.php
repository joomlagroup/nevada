    ...
    <div class="container_inner wrap_members clearfix">
        ...
        <div class="row">
            <div class="vc_col-md-4 member_area">
                ...
                <ul class="list_members">
                    ...
                    while ( $loop->have_posts() ) : $loop->the_post();
                        ...
                        ?>
                        <li><a href="<?php the_permalink() ?>" class="<?php if($current_id_member==get_the_ID()) echo 'current_item' ?>"> <?php echo sprintf("%02d", $index).' - '; ?>  <?php the_title(); ?></a></li>
                        <?php
                        $i++;
                        $index++;
                    endwhile;
            ...
            <div class="vc_col-md-8">
                ...
                <?php else: ?>
                    <?php
                    $args = array( 'post_type' => 'member','post__in' => array($current_id_member));
                    ...
                    <div class="list_pdf_file">
                        ...
                        $limit_pdf =5;
                        $current_id = $arr_id[0];
                        $pdfs = get_field('pdf',$current_id_member );
                        if($pdfs):
                            echo '<ul>';
