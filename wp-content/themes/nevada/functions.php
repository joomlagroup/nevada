...
$qode_ui_scripts['jquery-ui-core'] = 'JQuery UI Core';
$qode_ui_scripts['jquery-ui-widget'] = 'JQuery UI Widget';
$qode_ui_scripts['jquery-ui-accordion'] = 'JQuery UI Accordion';
$qode_ui_scripts['jquery-ui-autocomplete'] = 'JQuery UI Autocomplete';
$qode_ui_scripts['jquery-ui-button'] = 'JQuery UI Button';
$qode_ui_scripts['jquery-ui-datepicker'] = 'JQuery UI Datepicker';
$qode_ui_scripts['jquery-ui-dialog'] = 'JQuery UI Dialog';
$qode_ui_scripts['jquery-ui-draggable'] = 'JQuery UI Draggable';
$qode_ui_scripts['jquery-ui-droppable'] = 'JQuery UI Droppable';
$qode_ui_scripts['jquery-ui-menu'] = 'JQuery UI Menu';
$qode_ui_scripts['jquery-ui-mouse'] = 'JQuery UI Mouse';
$qode_ui_scripts['jquery-ui-position'] = 'JQuery UI Position';
$qode_ui_scripts['jquery-ui-progressbar'] = 'JQuery UI Progressbar';
$qode_ui_scripts['jquery-ui-selectable'] = 'JQuery UI Selectable';
$qode_ui_scripts['jquery-ui-resizable'] = 'JQuery UI Resizable';
$qode_ui_scripts['jquery-ui-sortable'] = 'JQuery UI Sortable';
$qode_ui_scripts['jquery-ui-sortable'] = 'JQuery UI Sortable';
$qode_ui_scripts['jquery-ui-slider'] = 'JQuery UI Slider';
$qode_ui_scripts['jquery-ui-spinner'] = 'JQuery UI Spinner';
$qode_ui_scripts['jquery-ui-tooltip'] = 'JQuery UI Tooltip';
$qode_ui_scripts['jquery-ui-tabs'] = 'JQuery UI Tabs';
$qode_ui_scripts['jquery-effects-core'] = 'JQuery Effects Core';
$qode_ui_scripts['jquery-effects-blind'] = 'JQuery Effects Blind';
$qode_ui_scripts['jquery-effects-bounce'] = 'JQuery Effects Bounce';
$qode_ui_scripts['jquery-effects-clip'] = 'JQuery Effects Clip';
$qode_ui_scripts['jquery-effects-drop'] = 'JQuery Effects Drop';
$qode_ui_scripts['jquery-effects-explode'] = 'JQuery Effects Explode';
$qode_ui_scripts['jquery-effects-fade'] = 'JQuery Effects Fade';
$qode_ui_scripts['jquery-effects-fold'] = 'JQuery Effects Fold';
$qode_ui_scripts['jquery-effects-highlight'] = 'JQuery Effects Highlight';
$qode_ui_scripts['jquery-effects-pulsate'] = 'JQuery Effects Pulsate';
$qode_ui_scripts['jquery-effects-scale'] = 'JQuery Effects Scale';
$qode_ui_scripts['jquery-effects-shake'] = 'JQuery Effects Shake';
$qode_ui_scripts['jquery-effects-slide'] = 'JQuery Effects Slide';
$qode_ui_scripts['jquery-effects-transfer'] = 'JQuery Effects Transfer';

$qode_options_proya['qode_ui_scripts'] = $qode_ui_scripts;

foreach ($qode_ui_scripts as $script => $name){
    $qode_options_proya['qode_ui_scripts_default_value'][] = $script;
}
...
if (!function_exists('qode_scripts')) {
    function qode_scripts() {
        ...
        $qode_ui_enabled_scripts = qode_options()->getOptionValue('qode_ui_scripts_option');
...
if ( ! function_exists( 'qode_is_wp_gutenberg_installed' ) ) {
	/**
	 * Function that checks if WordPress 5.x with Gutenberg editor installed
	 *
	 * @return bool
	 */
	function qode_is_wp_gutenberg_installed() {
